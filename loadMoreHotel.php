...
?>
                    ...
                    if (!skip) {
                        var html = '<tr class="hotel">'+
                                        '<td><a href="place?gid=<?php echo $objPlace["candidates"][0]["place_id"]?>"><img src="<?php echo $img?>" style="margin:10px"></td>'+
                                        '<td><a href="place?gid=<?php echo $objPlace["candidates"][0]["place_id"]?>"><b style="color:black"><?php echo $objPlace["candidates"][0]["name"]?></b></a><br><button>Set as Hotel</button></td>+'
                                    '</tr>';

<?php 
    if (isset($required)) {
        ...
        if ($_SESSION["lang"] == "EN") {
            ...
            $mail_recovery_text["content"] = "<span style='color:black'>們已收到你要求復原帳號的請求。<br></span><a href='http://".$_SERVER["HTTP_HOST"]."/fyp/recovery?code=".$secret."'>請按此連結</a><span style='color:black'>或使用以下連結來更改你的密碼。</span><br>http://".$_SERVER["HTTP_HOST"]."/fyp/recovery?code=".$secret;
        }

<?php 
    if (isset($required)) {
        ...
        if ($_SESSION["lang"] == "EN") {
            ...
            $setHotelPlan_text["choosetitle"] = "酒店";
            $setHotelPlan_text["search"] = "搜尋";
            $setHotelPlan_text["changeall"] = "改變每一天的酒店";
            $setHotelPlan_text["choosehotel"] = "選擇此酒店";
            $setHotelPlan_text["loadmore"] = "載入更多";
            $setHotelPlan_text["type"] = "類型: 酒店";
            $setHotelPlan_text["remove"] = "移除";
            $setHotelPlan_text["sethotel"] = "選擇酒店";
        }

...
<div id="test1" style="height:200px;width:200px"> 
<div class="quill_container">
...
<div id="test2" style="height:200px;width:200px"> 
</div>
<button>a</button>
<span id="asd"></span>
<script>
    ...
    quill2 = new Quill('.quill1', {
        modules: { toolbar: '.toolbar-container1' },
        theme: 'snow', bounds: "#test1  "
    });
    $("button").click(function() {
        var delta = quill.getContents();
        $("#asd").html(JSON.stringify(delta));
